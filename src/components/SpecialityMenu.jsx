...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
     <h1 className='text-3xl font-medium'>Find By Profession</h1>
     <p className='sm:w-1/3 text-center text-m'>You can easily browse through the list of trusted professionals and book them</p>
